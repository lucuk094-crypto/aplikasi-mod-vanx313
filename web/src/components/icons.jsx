// VAN MOD — set ikon SVG resmi (gaya outline 24px, stroke currentColor).
// Semua ikon digambar sebagai vektor, bukan emoji.

function make(paths) {
  return function Icon({ size = 18, filled = false, ...props }) {
    return (
      <svg
        width={size}
        height={size}
...
// Logo "V" VAN MOD sebagai SVG resmi.
export function VLogo({ size = 30 }) {
  return (
